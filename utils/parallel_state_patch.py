...
def get_model_parallel_rank():
    return mpu.get_model_parallel_group().rank()
...
def add_missing_mpu_methods():
    ...
    if not hasattr(mpu, 'get_model_parallel_rank'):
        mpu.get_model_parallel_rank = get_model_parallel_rank
    ...
    if not hasattr(mpu, 'get_model_parallel_world_size'):
        mpu.get_model_parallel_world_size = get_model_parallel_world_size
        print(
